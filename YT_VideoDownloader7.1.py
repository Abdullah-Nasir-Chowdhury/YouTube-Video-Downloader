# Progress bar keeps going behind the main window in v7.0
# Problem solved by using lift() function: root.lift()
# Also the attribute can be changed as: root.attributes("-topmost", True)
