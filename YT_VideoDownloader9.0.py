# Well, background music was a success. GIFs were a success...
# now... Just when will you allow the user to select the destination folder
# to save their video?
# And when will you allow them to select the stream they wish to download?
# When will you improve the download stats window?
# When will you provide a download stats window to the Playlist Downloader!?
# FFs get your ass on the road already... stop wasting time!!!

# Alright... time to be serious :3
...
def startIndividualDownload():
    ...
    def main():
        ...
        try:
            ...
            DownloadInformationLabel.configure(text="Failed :(", text_color="red")
            DownloadInformationLabel.update()
